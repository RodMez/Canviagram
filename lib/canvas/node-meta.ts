...
import { FolderKanban, ListChecks, StickyNote, Lightbulb, User, Package } from 'lucide-react'
...
export const NODE_META: Record<DBNode['type'], NodeMetaEntry> = {
  project:  { icon: FolderKanban, accent: 'border-sky-500/40 bg-sky-500/10',    label: 'Proyecto' },
